...
const Login = () => {
    let {formData,setFormData,setAuth} = useContext(AuthContext);
    let {error,loading,login} = useLoginHook();
    ...
    return (
            <div className="flex grow h-[600px] md:h-[650px] p-3 md:px-10 flex-col items-center justify-center border">
                ...
                <div className="flex gap-2 mt-2">
                    ...
                    <p onClick={() => {setAuth(false)}} className="text-green-600 cursor-pointer font-medium hover:underline">Sign in</p>
                </div>
            </div>
    );
};
